...
const Avances = (() => {
  ...
  function init() {
    ...
    document.getElementById('btn-capturar-resumen').addEventListener('click', () =>
  ...
  function renderFiltrosDropdowns() {
    ...
    selLabor.value = prevLabor; selResp.value = prevResp; selSector.value = prevSector;
  }
  ...
  function renderTarjetas(labores) {
    ...
    cont.innerHTML = labores.map(l => `
      <article class="card-labor">
        ...
        <p class="card-labor__meta">Jefe: ${escapeHtml(l.jefe)} · Inicio: ${escapeHtml(l.fecha_inicio)}</p>
